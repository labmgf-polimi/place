var map, featureList, municipalitiesSearch = [], bridgeSearch = [];
  ...
  bridges.eachLayer(function (layer) {
    if (map.hasLayer(bridgeLayer)) {
      if (map.getBounds().contains(layer.getLatLng())) {
        $("#feature-list tbody").append('<tr class="feature-row" id="' + L.stamp(layer) + '" lat="' + layer.getLatLng().lat + '" lng="' + layer.getLatLng().lng + '"><td style="vertical-align: middle;"><img width="16" height="18" src="assets/img/bridges.png"></td><td class="feature-name">' + layer.feature.properties.name + '</td><td style="vertical-align: middle;"><i class="fa fa-chevron-right pull-right"></i></td></tr>');
      }
    }
  });
  ...
  onEachFeature: function (feature, layer) {
    if (feature.properties) {
      var content = "<table class='table table-striped table-bordered table-condensed'>" +
                    ...
                    "<tr><th>Road code</th><td>" + feature.properties.road_code + "</td></tr>" +
                    "<tr><th>Owner</th><td>" + feature.properties.owner + "</td></tr>" +
                    "<tr><th>Technical report</th><td><a class='url-break' href='" + feature.properties.URL + "' target='_blank'>" + feature.properties.URL + "</a></td></tr>" +
                    "<tr><th>Inspections history</th><td><a id='inspections-history-" + feature.properties.id + "' class='url-break' href='#' data-id='" + feature.properties.id + "'>View Inspections</a></td></tr>" +
                    "<table>";
      layer.on({
        click: function (e) {
      ...
      document.addEventListener('click', function (e) {
        if (e.target && e.target.id === 'inspections-history-' + feature.properties.id) {
          var bridgeId = e.target.getAttribute('data-id');
          window.open('assets/php/inspections.php?fkStructure=' + bridgeId, '_blank');
...
$.getJSON("assets/php/get_assets.php", function (data) {
  ...
  bridgeLayer.addData(data); // Ensure bridgeLayer gets the data
...
attributionControl.onAdd = function (map) {
  ...
  div.innerHTML = "<span class='hidden-xs'>Developed by <a href='tars4815.github.io'>tars4815</a> | </span><a href='#' onclick='$(\"#attributionModal\").modal(\"show\"); return false;'>Attribution</a>";
  return div;
};
...
var groupedOverlays = {
  "Points of Interest": {
    "<img src='assets/img/bridges.png' width='24' height='28'>&nbsp;Bridges": bridgeLayer
  },
  "Reference": {
...
$(document).one("ajaxStop", function () {
  ...
  $("#searchbox").typeahead({
    ...
    templates: {
      header: "<h4 class='typeahead-header'><img src='assets/img/bridges.png' width='24' height='28'>&nbsp;Bridges</h4>",
